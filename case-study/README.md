...
| Option | Draft length | Story result | Visual idea | Best use |
|---|---:|---|---|---|
...
- A full timed [script for Quiet Signal](01-quiet-signal/SCRIPT.md)
- A full timed [script for The Work Between](02-the-work-between/SCRIPT.md)
- A full timed [script for Clearer Week](03-clearer-week/SCRIPT.md)
- A frame-by-frame storyboard and motion plan for each script
